...
neuron = 128
saved_loss_path = 'saved-loss/word2vec_h{}_loss.txt'.format(neuron)
saved_predict_path = 'saved-loss/word2vec_h{}_predict.txt'.format(neuron)
...
class BERTClassifier(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(768+100, neuron)
    ...
    def forward(self, input1, input2):
        ...
        news_tokenized = self.tokenizer.batch_encode_plus(input1,
                                                          ...
                                                          padding='max_length',
                                                          return_tensors='pt')
        news_hidden_outputs = self.model1(news_tokenized['input_ids'], attention_mask=news_tokenized['attention_mask'])
...
if __name__ == '__main__':
    # 获取数据
    train_input1, train_input2, train_label = get_data('rumdect/data/train_word2vec.txt')
    test_input1, test_input2, test_label = get_data('rumdect/data/test_word2vec.txt')
    ...
    '''
    # 加载参数
    saved_model_path = 'saved-model/word2vec_h128_e4.pkl'
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        checkpoint = {'model_state_dict': model.state_dict(),
                      ...
                      'epoch': epoch}
        saved_model_path = 'saved-model/word2vec_h{}_e{}.pkl'.format(neuron, epoch)
