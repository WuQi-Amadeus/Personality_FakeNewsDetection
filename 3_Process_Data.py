...
def get_data():
    s = time.time()
    rpath0 = 'rumdect/data/新闻与评论人格/真新闻/'
    rpath1 = 'rumdect/data/新闻与评论人格/假新闻/'
...
if __name__ == '__main__':
    ...
    with open('rumdect/data/train_data.txt', 'w', newline='', encoding='utf-8') as f:
        for d in train_data:
            f.write(str(d) + '\n')
    f.close()
    with open('rumdect/data/test_data.txt', 'w', newline='', encoding='utf-8') as f:
        for d in test_data:
            f.write(str(d) + '\n')
    f.close()
