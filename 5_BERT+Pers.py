...
neuron = 128
saved_loss_path = 'saved-loss/Pers_h{}_loss.txt'.format(neuron)
saved_predict_path = 'saved-loss/Pers_h{}_predict.txt'.format(neuron)
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        checkpoint = {'model_state_dict': model.state_dict(),
                      ...
                      'epoch': epoch}
        saved_model_path = 'saved-model/Pers_h{}_e{}.pkl'.format(neuron, epoch)
