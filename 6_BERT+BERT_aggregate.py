...
neuron = 128
saved_loss_path = 'saved-loss/aggr_h{}_loss.txt'.format(neuron)
saved_predict_path = 'saved-loss/aggr_h{}_predict.txt'.format(neuron)
...
class BERTClassifier(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(768*2, neuron)
...
if __name__ == '__main__':
    # 获取数据
    train_input1, train_input2, train_label = get_data('rumdect/data/train_bert.txt')
    test_input1, test_input2, test_label = get_data('rumdect/data/test_bert.txt')
    ...
    '''
    # 加载参数
    saved_model_path = 'saved-model/aggr_h128_e4.pkl'
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        checkpoint = {'model_state_dict': model.state_dict(),
                      ...
                      'epoch': epoch}
        saved_model_path = 'saved-model/aggr_h{}_e{}.pkl'.format(neuron, epoch)
